...
/***/ function(module, exports, __webpack_require__) {
	...
	var _circle_container = __webpack_require__(3);
	
	var _circle_container2 = _interopRequireDefault(_circle_container);
	...
	document.addEventListener('DOMContentLoaded', function () {
	  ...
	  var radius = stageWidth / 2 - 10;
	
	  var container = new _circle_container2.default();
	  var kaleidoscope = stage.addChild(new _kaleidoscope2.default(radius, container.container, 6, [10]));
	  kaleidoscope.x = stageWidth / 2;
	  kaleidoscope.y = stageHeight / 2;
	
	  createjs.Ticker.addEventListener("tick", (0, _util.tick)(container.container, stage));
	  createjs.Ticker.setFPS(70);
	  (0, _util.addKeyDownListener)(container);
	  (0, _util.addMenuListener)();
	  ...
	  resetButton.click(function () {
	    ...
	    container = new _circle_container2.default();
	    kaleidoscope = stage.addChild(new _kaleidoscope2.default(radius, container.container, 6, [10]));
	    kaleidoscope.x = stageWidth / 2;
	    kaleidoscope.y = stageHeight / 2;
	
	    createjs.Ticker.removeEventListener('tick', _util.tick);
	    createjs.Ticker.addEventListener('tick', (0, _util.tick)(container.container, stage));
	    (0, _util.addKeyDownListener)(container);
	  });
	});
...
/***/ function(module, exports) {
	...
	var Kaleidoscope = function (_createjs$DisplayObje) {
	  _inherits(Kaleidoscope, _createjs$DisplayObje);
	
	  function Kaleidoscope(radius, source, slices, pattern) {
	    _classCallCheck(this, Kaleidoscope);
	
	    var _this = _possibleConstructorReturn(this, (Kaleidoscope.__proto__ || Object.getPrototypeOf(Kaleidoscope)).call(this));
	    ...
	    for (var _i = 0; _i < slices; _i++) {
	      _this.slices[_i] = pattern[_i % patternLength] / sym * Math.PI;
	    }
	
	    $('#seam').change(function (event) {
	      _this.changeSeams(event.currentTarget.value);
	    });
	
	    $('#mirror').change(function (event) {
	      _this.changeSlices(event.currentTarget.value);
	    });
	    return _this;
	  }
	  ...
	  _createClass(Kaleidoscope, [{
	    ...
	    value: function draw(ctx) {
	      var seam = this.seam / (Math.PI * this.radius * 2);
	    ...
	    key: 'drawSlice',
	    value: function drawSlice(context, radius, a, mirror, seam) {
	      context.save();
	      ...
	      context.arc(0, 0, this.radius, 0 - (mirror ? 1 : 0) * seam, a + (mirror ? 1 : 0) * seam);
	    ...
	    key: 'changeSeams',
	    value: function changeSeams(val) {
	      this.seam = parseInt(val);
	    }
	  }, {
	    key: 'changeSlices',
	    value: function changeSlices(num) {
	      ...
	      for (var _i2 = 0; _i2 < num; _i2++) {
	        slices[_i2] = this.pattern[_i2 % patternLength] / sym * Math.PI;
	      }
...
/***/ function(module, exports) {
	...
	var tick = exports.tick = function tick(container, stage) {
	  return function () {
	    var radioButtons = $('input:radio[name=rotation]');
	...
	var addKeyDownListener = exports.addKeyDownListener = function addKeyDownListener(container) {
	  var handleKeyPress = function handleKeyPress(event) {
	    ...
	    var info = keyCodes[event.keyCode];
	    var instrument = $('input:radio[name=instrument]');
	    var sound = void 0;
	...
	var addMenuListener = exports.addMenuListener = function addMenuListener() {
	  var menuButton = $('#controls-icon');
...
/***/ function(module, exports) {
	...
	var CircleContainer = function (_createjs$DisplayObje) {
	  _inherits(CircleContainer, _createjs$DisplayObje);
	
	  function CircleContainer() {
	    _classCallCheck(this, CircleContainer);
	
	    var _this = _possibleConstructorReturn(this, (CircleContainer.__proto__ || Object.getPrototypeOf(CircleContainer)).call(this));
	
	    _this.container = new createjs.Container();
	    _this.container.height = 400;
	    _this.container.width = 400;
	    ...
	    _this.container.addChild(circle3, circle1);
	    return _this;
	  }
	  ...
	  _createClass(CircleContainer, [{
	    key: "addChild",
	    value: function addChild(color, object) {
	      var shape = new createjs.Shape();
	      var x = Math.floor(Math.random() * this.container.height) + 1;
	      var y = Math.floor(Math.random() * this.container.width) + 1;
	      var radius = Math.floor(Math.random() * 70) + 1;
	...
	exports.default = CircleContainer;
